...
$fecha = date("Y-m-d");
$empresa = isset($_POST['empresa']) && $_POST['empresa'] != "" ? $_POST['empresa'] : 1;
$documento_id = isset($_POST['documento_id']) && $_POST['documento_id'] != "" ? $_POST['documento_id'] : 1;
$cai = isset($_POST['cai']) ? $_POST['cai'] : '';
...
$query = "SELECT secuencia_facturacion_id
	...
	WHERE activo = 1 AND empresa_id = '$empresa' AND documento_id = '$documento_id'";
