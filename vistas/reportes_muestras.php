    ...
    <div class="card-body">
      <form id="form_main" class="form-inline">
        ...
        <div class="form-group">
          <button class="btn btn-success mt-2" type="submit" id="reporte_excel"><div class="sb-nav-link-icon"></div><i class="fas fa-download fa-lg"></i> General</button>
        </div>
        <div class="form-group">
            <button class="btn btn-danger mt-2 ml-1" type="submit" id="limpiar"><div class="sb-nav-link-icon"></div><i class="fas fa-search fa-lg"></i> Limpiar</button>
        </div>
      </form>
    </div>
