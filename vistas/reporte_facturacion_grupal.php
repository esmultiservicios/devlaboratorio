...
$comentario = "Ingreso al Modulo de Reporte de Facturacion";
...
<head>
    ...
    <title>Reporte de Facturación Grupal:: <?php echo $empresa; ?></title>
...
<div class="container-fluid">
  ...
  <div class="card mb-4">
    ...
    <div class="card-body">
      <form id="form_main_grupal" class="form-inline">
	...
	<?php
		...
		include "../js/main.php";
		include "../js/myjava_reportes_facturacion_grupal.php";
